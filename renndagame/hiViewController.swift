...
//  renndagame
//
//  Created by 古長谷鷹念 on 2019/03/06.
...
class hiViewController: UIViewController {
    ...
    @IBOutlet var hiImageView : UIImageView!
    
    
    override func viewDidLoad() {
        super.viewDidLoad()
        timer = Timer.scheduledTimer(timeInterval:0.22, target: self, selector: #selector(self.update), userInfo: nil, repeats: true)
        timer.fire()
