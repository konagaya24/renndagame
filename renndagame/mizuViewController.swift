//
//  mizuViewController.swift
//  renndagame
//
//  Created by 古長谷鷹念 on 2019/01/30.
//  Copyright © 2019 古長谷鷹念. All rights reserved.
//

import UIKit

class mizuViewController: UIViewController {
    ...
    @IBAction func plus() {
        if hp >= 2{
            ...
            if(flag) {
                ...
                timer1 = Timer.scheduledTimer(timeInterval: 0.03, target: self, selector: #selector(self.timerupdate), userInfo: nil, repeats: true)
                flag = false
            }
